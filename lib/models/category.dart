class CategoryFeed {
  String version;//i do not know what is this
  String encoding;//i do not know what is thi
  Feed feed;
...
}//مش عارف ايه لزمتها في الحياة اصلا

class Feed {
  String xmlLang;//i do not know what is this
  String xmlns;//i do not know what is this
  String xmlnsDcterms;//i do not know what is this
  String xmlnsThr;//i do not know what is this
  String xmlnsApp;//i do not know what is this
  String xmlnsOpensearch;//i do not know what is this
  String xmlnsOpds;//i do not know what is this
  String xmlnsXsi;//i do not know what is this
  String xmlnsOdl;//i do not know what is this
  String xmlnsSchema;//i do not know what is this
  Id id;
  Id title;
  Id updated;
  Id icon;
